    ...
    public void Configure(EntityTypeBuilder<AiCallLog> builder)
    {
        ...
        builder.ToTable(t =>
        {
            ...
            t.HasCheckConstraint("chk_ai_logs_type",
                "call_type IN ('format_words', 'generate_test', 'generate_fill_sentences', 'generate_distractors', 'generate_definitions', 'suggest_title', 'conversation', 'analyze_conversation')");
