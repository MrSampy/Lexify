...
namespace Lexify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260724100307_AddBlockSharing")]
    partial class AddBlockSharing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lexify.Domain.Entities.BlockShare", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("BlockId")
                        .HasDatabaseName("idx_block_shares_block");

                    b.HasIndex("OwnerUserId");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("idx_block_shares_token");

                    b.ToTable("block_shares", (string)null);
                });
            ...
            modelBuilder.Entity("Lexify.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.Property<int?>("WordsUsed")
                        .HasColumnType("integer")
                        .HasColumnName("words_used");
            ...
            modelBuilder.Entity("Lexify.Domain.Entities.Test", b =>
                {
                    ...
                    b.ToTable("tests", null, t =>
                        {
                            t.HasCheckConstraint("chk_tests_status", "status IN ('generating', 'ready', 'failed', 'archived')");
                        });
                });
            ...
            modelBuilder.Entity("Lexify.Domain.Entities.Word", b =>
                {
                    ...
                    b.Property<List<string>>("AlternativeTranslations")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
